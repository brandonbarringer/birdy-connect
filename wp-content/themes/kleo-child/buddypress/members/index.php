		...
		<div id="subnav" class="item-list-tabs" aria-label="<?php esc_attr_e( 'Members directory main navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
				...
				if( $member_type ){
					...
					?>
					<li class="selected" id="members-all"><a href="<?php bp_members_directory_permalink(); ?>"><?php printf( __( 'All %s %s', 'kleo_framework' ), $member_type->labels['name'] , bp_get_total_member_count() ); ?></a></li>
				<?php } else { ?>

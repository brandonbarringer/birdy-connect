...
<?php _e('I would suggest you to checkout the','easy-coming-soon') ?>  <a href = "http://easycomingsoon.com/demos/" target="_blank"><?php _e('Sample Coming Soon Page','easy-coming-soon') ?></a> <?php _e('created by the premium version of the plugin.','easy-coming-soon') ?> <br><br>
<?php _e('Also Check out the Admin Panel','easy-coming-soon') ?> <a href = "http://easycomingsoon.com/demos/" target="_blank"><?php _e('here','easy-coming-soon') ?></a><?php _e('. User Login: user and Password: user','easy-coming-soon') ?>
<br><br>
</p>
	</div>

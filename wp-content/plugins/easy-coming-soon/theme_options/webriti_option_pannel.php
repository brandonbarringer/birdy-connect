<div class="wrap settings-wrap" id="page-settings">
    ...
    <div id="option-tree-sub-header"></div>
        <div class = "ui-tabs ui-widget ui-widget-content ui-corner-all">
            <ul>
                ...
                <li id="tab_notification_setting"><a href="#section_notification"><?php _e('Notification','easy-coming-soon');?></a>
                </li>
	...
	<div id="section_about_vid_tutorial" class = "postbox">
							...
							<form method="post" id="easy-coming-soon_lite_theme_options_5">
									<div id="heading">
										<table style="width:100%;"><tr>
											...
											<br>
											<p><?php _e('In this','easy-coming-soon') ?> <a target = "_blank" href = "https://www.youtube.com/watch?v=jwXOO9DDSpY"><?php _e(' Video Tutorial','easy-coming-soon') ?> </a><?php printf(__(' , I will demonstrate how you can create a fully functional Coming Soon Page in as little as 30 minutes.','easy-coming-soon')); ?></p>
		...
		<img  style="height:50%; width:50%" src="<?php echo plugins_url('/pages/images/img/video-thumb.jpg',__FILE__);?>" alt="" style="width:100%"> 
										...
										</p><?php _e('The premium version is priced at 29 USD and lets you use the plugin on unlimited website.','easy-coming-soon') ?> </p>
											<p><?php printf(__('Here is the ','easy-coming-soon')) ?><a target = "_blank" href = "https://youtu.be/JEbKUdvbzys"><?php _e('link to the Video.','easy-coming-soon') ?></a> <?php _e('Enjoy!!!','easy-coming-soon') ?></p>
											</td>
											<td style="width:30%;">
											</td>
											<td style="text-align:right;">					

	...
	<form method="post" action="#section_design">
		...
		<div class="section">
            <div class="element">
                ...
                <input type="radio" name="background_effect" value="0" id="background_effect"  <?php if($current_options['background_effect']=='0') echo 'checked' ?>/>&nbsp;None<br>
                <input type="radio" name="background_effect" value="1" id="background_effect" <?php if($current_options['background_effect']=='1') echo 'checked' ?>/>&nbsp;Noise
            </div>
        </div>

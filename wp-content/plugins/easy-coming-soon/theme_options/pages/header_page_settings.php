	...
	<form method="post" action="#section_general">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Quick Start Settings','easy-coming-soon');?></h2></td>
				<td style="width:30%;">
				...
				<td style="text-align:right;">					
					<input class="button" type="submit" name="easy-coming-soon_lite_settings_reset_1" value="Restore Defaults" >&nbsp;
					<input class="button button-primary button-large" type="submit" name="easy-coming-soon_lite_settings_save_1" value="Save Options">
				</td>
				</tr>
			</table>			
		</div>	
		...
		<div class="section">
            <div class="element">
                ...
                <input type="radio" name="status" value="1" id="status" <?php if($current_options['status']=='1') echo 'checked' ?>/>&nbsp;<?php _e('Coming soon enabled','easy-coming-soon') ?>
            </div>
        </div>

        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter background image','easy-coming-soon') ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter the title','easy-coming-soon') ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter description','easy-coming-soon') ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter facebook URL','easy-coming-soon') ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter twitter URL','easy-coming-soon') ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter google-plus URL','easy-coming-soon') ?></h3>
		...
		<div id="button_section">
			<input class="button button-primary" type="submit" name="easy-coming-soon_lite_settings_save_1"value="Save Options">&nbsp;
			<input class="button" type="submit" name="easy-coming-soon_lite_settings_reset_1" value="Restore Defaults">
		</div>

<div class="block ui-tabs-panel active" id="option-ui-id-7" >
	...
	<div class="span6" style="width:80%;margin-top: auto;text-align:center">
		<h3 style="font-size: 45px !important;
font-style: normal;
font-weight: 900;
line-height:1.1;
color: #000;
...
color: #707070;
text-align: left;"><?php _e('Hey There,','easy-coming-soon') ?> <br><br><?php _e('Thanks for using the lite version of Easy Coming Soon. I hope the plugin will enable you to quickly and easily create a landing page.','easy-coming-soon') ?><br><br>
...
It has a lot of additional features which will allow you to quickly create a good looking landing page.','easy-coming-soon') ?>  <br><br>

<?php _e('I would suggest you to checkout the','easy-coming-soon') ?>  <a href = "http://easycomingsoon.com/demos/" target="_blank"><?php _e('Sample Coming Soon Page</a> created by the premium version of the plugin.','easy-coming-soon') ?> <br><br>
<?php _e('Also Check out the Admin Panel','easy-coming-soon') ?> <a href = "http://easycomingsoon.com/demos/" target="_blank"><?php _e('here','easy-coming-soon') ?></a>
<?php printf(__('. User Login: user and Password: user','easy-coming-soon')) ?>
<br><br>
</p>
	</div>
 ...
 <h3 style="margin-left:25px;font-size:20px;"><?php _e('Here is the complete List of Features in Pro Version ','easy-coming-soon') ?></h3><br>
 </div>
...
<h3><?php _e('Priyanshu','easy-coming-soon') ?></h3>
<h3><?php _e('Co-Founder, EasyComingSoon','easy-coming-soon') ?></p></h3>
</div>	
 </div>

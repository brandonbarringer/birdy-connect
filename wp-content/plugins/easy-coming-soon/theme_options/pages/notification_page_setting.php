	...
	<form method="post" action="#section_notification">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Mailing Option settings','easy-coming-soon');?></h2></td>
				<td style="width:30%;">
		...
		<div class="section placeholder_text_section">
            <div class="element">
				...
				<p><?php _e('Use Shortcode :','easy-coming-soon') ?> <strong style="font-size:15px;">[email]</strong> <?php _e('to include the email address entered by the Subscriber','easy-coming-soon') ?></p>
			</div>
        </div>

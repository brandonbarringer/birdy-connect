...
<h3><?php _e('How to Purchase.','easy-coming-soon') ?></h3>
			<p><?php _e('If you are interested then you can buy the plugin','easy-coming-soon') ?> <a href = "http://member.easycomingsoon.com/pricing/" target = "_blank"><?php _e('here.','easy-coming-soon') ?></a>  <?php printf(__('Once the purchase process gets complete, the license key will be emailed to you. Add and activate this license key in the License option page in the Premium version of this plugin. Make sure that you activate this license key in order to enjoy the continue support and plugin updates.','easy-coming-soon')) ?></p>

		...
		vc_map(
			array(
				...
				'params'          => array(
					...
					array(
						'param_name'  => 'divided',
						'heading'     => __( 'Divided Items', 'kleo_framework' ),
						'description' => __( 'Apply border between items', 'kleo_framework' ),
						'type'        => 'dropdown',
						'holder'      => "div",
						'class'       => 'hide hidden',
						'value'       => array(
					...
					array(
						...
						'heading'     => __( 'Title only', 'kleo_framework' ),
						'description' => __( 'Just the Title visible by default. Content is visible on item hover', 'kleo_framework' ),
						'type'        => 'dropdown',
						'holder'      => "div",
						'class'       => 'hide hidden',
						'value'       => array(
